...
export const getEvaluationHistoryDealDetail = params => { // 实验平台分时图
    return post(`${requestPrefix}/evaluation/evaluationtimedealdetail`, params);
};
export const getEvaluationSteadyStateAnalysis = params => { // 实验平台分时图
    return post(`${requestPrefix}/evaluation/evaluationsteadystateanalysis`, params);
};