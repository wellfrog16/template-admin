            ...
            <s-card title="账户组信息" icon="fa fa-layer-group" :minHeight="300">
                ...
                <div slot="content">
                    <el-row :gutter="20">
                        <el-col :span="21">
                            <div>
                                <tree-table ref="self-tree-table" :filterText="searchText" :columns="mainTableColumnsBI" :tableData="mainTableData" :clearAllSelected="true" :limitQtty="limitQtty" @updateCheckedList="updateCheckedList" @handleClearAll="handleClearAll"></tree-table>
                            </div>
                        </el-col>
                        <el-col :span="3">
