...
export default {
    ...
    methods: {
        ...
        toggleDetail(item, index) {
            ...
            if (!item.toggleDetailFlags) {
                this.$nextTick(() => {
                    ...
                    console.log(this.$store.getters.getchart1);
        ...
        getBlock2Data() {
            ...
            // getChartTable2ByPage({...params, ...{pageSize: 10, pageNum: 1}}).then(resp => {
            //     console.log(resp);
            // });
            // getChart2Data({...params, ...{pageSize: 10, pageNum: 2}}).then(resp => {
            //     console.log(resp);
            // });
        },
        getBlock3Data() {
