...
export default {
    ...
    data() {
        return {
            ...
            loadingAR1: false,
            columnsList1: [
                {field: 'time1', label: '公布日期', minWidth: 130, align: 'center'},
                {field: 'time2', label: '公布日期', minWidth: 130, align: 'center'},
                {field: 'time3', label: '公布日期', minWidth: 130, align: 'center'},
                {field: 'time4', label: '公布日期', minWidth: 130, align: 'center'},
                {field: 'time5', label: '公布日期', minWidth: 130, align: 'center'},
                {field: 'time6', label: '公布日期', minWidth: 130, align: 'center'}
            ],
            tableData1: [
                {'time1': '21', 'time2': '21', 'time3': '21', 'time4': '21', 'time5': '21', 'time6': '21'},
                {'time1': '21', 'time2': '21', 'time3': '21', 'time4': '21', 'time5': '21', 'time6': '21'},
