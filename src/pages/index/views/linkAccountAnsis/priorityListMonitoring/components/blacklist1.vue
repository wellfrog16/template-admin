<template>
    <div :class="$style.black_list1">
        <s-card :title="`筛选条件`" :icon="`fa fa-chart-line`" style="padding: 0;">
            <el-form
                slot="content"
                :model="ruleForm"
                :rules="rules"
                ...
                <el-row :class="$style.card1">
                    <el-col :xl="6" :lg="6" :md="6" :sm="12">
                        ...
                        <el-form-item label="撤单次数" prop="timeInput1" label-width="100px">
                            <el-input
                                style="width: 100%;"
                    ...
                    <el-col :xl="6" :lg="6" :md="6" :sm="12">
                        <el-form-item label="合约" prop="timeInput2" label-width="100px">
                            <el-input
                                style="width: 100%;"
                    ...
                    <el-col :xl="6" :lg="6" :md="6" :sm="12">
                        <el-form-item label="持仓量" prop="timeInput4" label-width="100px">
                            <el-input
                                style="width: 100%;"
                    ...
                    <el-col :xl="6" :lg="6" :md="6" :sm="12">
                        <el-form-item label="下单次数" prop="timeInput6" label-width="100px">
                            <el-input
                                style="width: 100%;"
        ...
        <div :class="$style.black_lists">
            <div :class="$style.box1" style="margin-right: 20px;">
                <s-card :title="`黑名单列表`" :icon="`fa fa-chart-line`">
                    ...
                    <div slot="content" style="text-align:center; margin-top: 20px; width: 100%;">
                        <el-button
                            size="small"
                            type="primary"
                            @click="importClick">
