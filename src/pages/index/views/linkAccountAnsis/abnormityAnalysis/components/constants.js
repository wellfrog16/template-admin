...
export const tableColumns = [
    ...
    {field: 'acctMultiMakePosQtty', label: '账户组多单持仓量', width: 160, align: 'center', sortable: true, sortMethod: Vue.prototype.gfnSortByNumber},
    {field: 'acctBillMakePosQtty', label: '账户组空单持仓量', width: 160, align: 'center', sortable: true, sortMethod: Vue.prototype.gfnSortByNumber},
    {field: 'multiBillMakePosQtty', label: '账户多单持仓量', width: 160, align: 'center', sortable: true, sortMethod: Vue.prototype.gfnSortByNumber},
    {field: 'billMakePosQtty', label: '账户空单持仓量', width: 160, align: 'center', sortable: true, sortMethod: Vue.prototype.gfnSortByNumber},
