...
export const tableColumns = [
    ...
    {field: 'custPositionMult', label: '账户多单持仓量', width: 160, align: 'center', sortable: true, sortMethod: Vue.prototype.gfnSortByNumber},
    {field: 'custPosition', label: '账户空单持仓量', width: 160, align: 'center', sortable: true, sortMethod: Vue.prototype.gfnSortByNumber},
    {field: 'freDraBill', label: '频繁报撤单', width: 150, align: 'center'},
    {field: 'bargain', label: '自成交', width: 150, align: 'center'},
    {field: 'xposQtty', label: '限仓量', width: 150, align: 'center'},
];
