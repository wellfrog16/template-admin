...
export const columnsCTrI3 = [
    ...
    {field: 'birthdt', label: '出生日期', width: '200'},
    {field: 'localTaxid', label: '当地纳税号', width: '250'},
    {field: 'localSocialsecurityid', label: '当地社保ID', width: '250', align: 'center'},
    {field: 'localId', label: '当地身份证号', width: '250'},
    {field: 'licenceId', label: '驾照号', width: '200'},
    {field: 'hkMacaoPass', label: '港澳居民来往内地通行证', width: '280', align: 'center'},
    {field: 'workUnit', label: '工作单位', width: '200'},
    {field: 'position', label: '职位', width: '200'},
    {field: 'corpChar', label: '单位性质', width: '200'},
    {field: 'email', label: '电子邮件', width: '200'},
...
export const columnsCTrI4 = [
    ...
    {field: 'localSocialsecurityid', label: '当地社保ID', width: '200', align: 'center'},
    {field: 'localId', label: '当地身份证号', width: '200'},
    {field: 'licenceId', label: '驾照号', width: '200'},
    {field: 'hkMacaoPass', label: '港澳居民来往内地通行证', width: '300', align: 'center'},
    {field: 'workUnit', label: '工作单位', width: '200'},
    {field: 'position', label: '职位', width: '200'},
    {field: 'corpChar', label: '单位性质', width: '200'},
    {field: 'email', label: '电子邮件', width: '200'},
    {field: 'zdxSoloName', label: '指定下单人姓名', width: '200'},
    {field: 'zdxSoloDoctype', label: '指定下单人证件类型', width: '260', align: 'center'},
    {field: 'zdxSoloDocid', label: '指定下单人证件号码', width: '260', align: 'center'},
    {field: 'zdxSoloAddr', label: '指定下单人地址', width: '250'},
    {field: 'zdxSoloZipCd', label: '指定下单人邮编', width: '250'},
    {field: 'fundTranpername', label: '资金调拨人姓名', width: '250', align: 'center'},
    {field: 'fundTranperaddr', label: '资金调拨人地址', width: '250', align: 'center'},
    {field: 'fundTranperzipCd', label: '资金调拨人邮编', width: '250', align: 'center'},
    {field: 'statCfmname', label: '结算单确认人姓名', width: '250', align: 'center'},
    {field: 'statCfmaddr', label: '结算单确认人地址', width: '250', align: 'center'},
    {field: 'statCfmzipCd', label: '结算单确认人邮编', width: '250', align: 'center'},
    {field: 'custOpenmodel', label: '客户开户模式', width: '200'},
    {field: 'oaiName', label: '开户或中介机构名称', width: '280'},
    {field: 'oaiFilingid', label: '开户或中介机构备案号', width: '280', align: 'center'}
];
