        ...
        <s-card :title="`关系图库`" :icon="`fa fa-user-md`">
            <div slot="content">
                ...
                <div>
                    ...
                    <div id="main" :class="$style.bar_echarts"></div>

                    <div id="main_1">节点关系提示区</div>
                </div>
            </div>
        </s-card>
    </div>
        ...
        clearChartData(val) {
                ...
                tooltip: {
                    ...
                    formatter: function(params, ticket, callback) {
                            ...
                            success: function(data) {
                                ...
                                if (category == 2) {
                                    ...
                                    res +=
                                        ...
                                        "<br/>";
                                    res +=
                                        "空闲线程：" + data.ideThread + "<br/>";
                                    res +=
                                        "总线程：" + data.totalThread + "<br/>";
                                    res +=
                                        "每秒处理的线程数比率：" +
                                        data.throuhput +
                                        "<br/>";
                        ...
                        if (category == 2 || category == 4) {
                            ...
                            //其他情况显示所属图例以及名称
                            return (
                                myChart.getOption().series[params.seriesIndex]
            ...
            function appendPath(params) {
                ...
                if (params.dataType == "node") {
                    ...
                    var categoryName =
                        series.categories[params.data.category].name; //获取当前节点的图例名称
                    ...
                    while (true) {
                        ...
                        //获取父节点的图例名称并连接
                        str =
                            series.categories[nodesOption[map[id]].category]
                                .name +
                            ":" +
                            nodesOption[map[id]].name +
                            "->" +
                            str;
                        id = map[id];
                    }
